...
_LIB_CSS = """<style>
  :root{--cream:oklch(97.5% .014 75);--paper:oklch(99.6% .004 85);--ink:oklch(23% .025 45);--muted:oklch(46% .03 45);--faint:oklch(62% .025 55);--line:oklch(89% .02 60);
    --accent:oklch(64% .16 45);--deep:oklch(50% .14 40);--soft:oklch(94% .05 55);
  ...
  *{box-sizing:border-box}
  ...
  .kick{display:inline-flex;align-items:center;gap:7px;font-family:var(--mono);font-size:11px;font-weight:600;letter-spacing:.1em;text-transform:uppercase;color:var(--deep);background:var(--paper);padding:6px 12px;border-radius:999px;margin:0 0 14px;box-shadow:0 1px 0 rgba(0,0,0,.02)}
  .kick::before{content:"";width:6px;height:6px;border-radius:50%;background:var(--accent)}
  .h1{font-family:var(--serif);font-weight:600;font-size:30px;line-height:1.12;letter-spacing:-.01em;margin:0 0 8px;text-wrap:balance}
  ...
  .sec{margin:26px 0 0}
  .qh{font-family:var(--serif);font-weight:600;font-size:19px;margin:0 0 6px;color:var(--ink)}
