...
target_queries:
  ...
  - "gifted and learning disability"
...
faq:
  - q: "What does twice-exceptional (2e) mean?"
    a: "Twice-exceptional, or 2e, means a child is gifted and also has one or more disabilities or learning differences, such as ADHD, dyslexia, or autism. They have real strengths and real challenges at the same time."
  - q: "Can a gifted child have ADHD or dyslexia?"
    a: "Yes. Giftedness and a disability can co-occur. That combination is exactly what twice-exceptional describes, and ADHD, dyslexia, and autism are among the most common pairings."
  - q: "Why are twice-exceptional kids often missed?"
    a: "Because the two sides mask each other. Giftedness can hide the disability (the child compensates and looks fine), or the disability can hide the giftedness (struggles get read as laziness). Many end up labeled underachievers instead of 2e."
  - q: "How do you support a twice-exceptional child?"
    a: "Feed the strengths and support the challenge at the same time. That usually means a challenging, interest-led curriculum plus specific accommodations, rather than only remediation or only enrichment."
sources:
  - label: "Reis, Baum & Burke (2014), operational definition of 2e (Gifted Child Quarterly), via NAGC / Univ. of Iowa"
    url: "https://iro.uiowa.edu/esploro/fulltext/report/Twice-Exceptional-Learners/9984655812902771"
    accessed: 2026-07-24
...
cta:
  text: "See a school that feeds strengths and supports the child"
